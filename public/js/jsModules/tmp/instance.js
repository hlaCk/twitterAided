...
const
	...
	var
		...
		moduleMaker = function moduleMaker(id) {
			$this = this;
			if(isInstance(id)) return modules[id];
	...
	// don't want outsider redefining "instance" and don't want
	...
	instance.moduleMaker = moduleMaker;

	return instance;
})();

const moduleMaker = instance.moduleMaker;

var run = function (name) {
	instance(name); // doesn't return exports
};
...
export { run, instance, getExportedData };
