import { getExportedData, default as lib } from './lib.js';
import { default as mix } from './mix.js';
const moduleID = 'fetch';

var {module, exports, controller} = getExportedData(lib(moduleID));
...
(function (root, factory) {
    ...
    // return exports["fetch"] = factory();
    else
        root.returnExports = factory(root, exports);

})(typeof self !== 'undefined' ? self : this, function (global, exports) {
    controller && controller.file('/js/jsModules/fetch.js');
    // module.file = '/js/jsModules/fetch.js';
    // module.requires = [];
    module.exportsMap = [
        'makeWarpper',
        'all',
