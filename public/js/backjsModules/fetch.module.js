import { getExportedData, acquire } from './acquire.js';
import { mix } from './mix.js';
const moduleID = 'fetch';

var {module, exports, controller} = getExportingVars(acquire(moduleID));
...
let tt=
(function (module, exports, acquire) {
	if(typeof module === 'undefined')
		module = acquire(moduleID);
